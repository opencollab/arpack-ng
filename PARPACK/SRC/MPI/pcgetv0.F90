...
!
!  ITRY    Integer.  (INPUT)
!          ITRY counts the number of times that pcgetv0 is called.
!          It should be set to 1 on the initial call to pcgetv0.
!
...
!     pclarnv  Parallel wrapper for LAPACK routine clarnv (generates a random vector).
