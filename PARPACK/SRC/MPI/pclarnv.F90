...
!\Description:
!
!  Parallel Version of ARPACK utility routine clarnv
!
!  PCLARNV returns a vector of n (nloc) random Complex numbers from a uniform or
...
!\Details
!
!  Simple parallel version of LAPACK auxiliary routine clarnv
!  for X distributed across a 1-D array of processors.
!  This routine calls the auxiliary routine CLARNV to generate random
!  Complex numbers from a uniform or normal distribution. Output is consistent
!  with serial version.
!
!\SCCS Information:
