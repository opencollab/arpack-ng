...
!
!  ITRY    Integer.  (INPUT)
!          ITRY counts the number of times that pdgetv0 is called.
!          It should be set to 1 on the initial call to pdgetv0.
!
...
!     pdvout   Parallel ARPACK utility routine for vector output.
!     pdlarnv  Parallel wrapper for LAPACK routine dlarnv (generates a random vector).
