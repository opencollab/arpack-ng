...
!
!  pdsaupd  is usually called iteratively to solve one of the
!  following problems:
!
...
!          Must be 1,2,3,4,5; See under \Description of pdsaupd  for the
...
!     with the ARPACK subroutine pdseupd .
!
!  2. If the Ritz vectors corresponding to the converged Ritz values
!     are needed, the user must call pdseupd  immediately following completion
!     of pdsaupd . This is new starting with version 2.1 of ARPACK.
!
...
!
!\Routines called:
!     pdsaup2   Parallel ARPACK routine that implements the Implicitly Restarted
!              Arnoldi Iteration.
!     dstats    ARPACK routine that initializes timing and other statistics
!              variables.
