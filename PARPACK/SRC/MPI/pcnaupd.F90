...
!          DEFAULT = pslamch10(comm, 'EPS')  (machine precision as computed
!                    by the ScaLAPACK auxiliary subroutine pslamch10).
!
...
!          Must be 1,2,3; See under \Description of pcnaupd for the
...
!
!\Routines called:
!     pcnaup2  Parallel ARPACK routine that implements the Implicitly Restarted
!              Arnoldi Iteration.
...
!        | The final workspace is needed by subroutine pcneigh called  |
!        | by pcnaup2. Subroutine pcneigh calls LAPACK routines for    |
